...
The logo appears in the header and footer of every page, but it is one file: `assets/img/logo.png`. Change that file and all 43 pages change. (As of 9/8 it already carries the ZONECO wordmark from thezoneco.com; the steps below are for replacing it with your original artwork.)
